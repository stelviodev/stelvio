...
While still in beta, we hope this guide shows how much it simplifies AWS infrastructure for Python developers.
...
Your REST API will be available at `https://<api-id>.execute-api.<region>.amazonaws.com/v1`.
If you want to use a custom domain, please refer to the [REST API guide](../components/aws/rest-api.md).
