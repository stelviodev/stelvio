...
@pulumi.runtime.test
def test_function_dev_mode__(pulumi_mocks, dev_mode_context, test_case):
...
@mark.parametrize(
    "zip_path",
    [
        param("/etc/ca.pem", id="absolute"),
        param("../ca.pem", id="parent"),
        param("certs/../../ca.pem", id="nested-parent"),
        param("", id="empty"),
        param(".", id="dot"),
    ],
)
