...
You can link other resources to your notification function using the `links` parameter. For details on how linking works and default permissions, see the [Linking guide](linking.md).
...
The `Bucket` component supports the `customize` parameter to override underlying Pulumi resource properties. For an overview of how customization works, see the [Customization guide](customization.md).
