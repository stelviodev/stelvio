...
def test_canonical_list_has_21_entries():
    """Exactly 21 component types exist."""
    assert len(CANONICAL_URNS) == 21
...
SIMPLE_COMPONENTS = [
    ...
    ("UserPool", lambda: UserPool("test-user-pool"), "stelvio:aws:UserPool"),
